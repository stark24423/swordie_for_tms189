...
public enum OutHeader {
    CHECK_PASSWORD_RESULT(0),     // 189 ready
    WORLD_INFORMATION(1),     // 189 ready
    LATEST_CONNECTED_WORLD(2),     // 189 ready
    RECOMMENDED_WORLD_MESSAGE(3),
    SET_CLIENT_KEY(4),
    SET_PHYSICAL_WORLD_ID(5),     // 189 ready
    SELECT_WORLD_RESULT(6),     // 189 ready
    SELECT_CHARACTER_RESULT(7),     // 189 ready
    ACCOUNT_INFO_RESULT(8),     // 189 ready
    CREATE_MAPLE_ACCOUNT_RESULT(9),
    CHECK_DUPLICATED_ID_RESULT(10),     // 189 ready
    CREATE_NEW_CHARACTER_RESULT(11),     // 189 ready
    DELETE_CHARACTER_RESULT(12),     // 189 ready
    RESERVED_DELETE_CHARACTER_RESULT(13),
    RESERVED_DELETE_CHARACTER_CANCEL_RESULT(14),
    RENAME_CHARACTER_RESULT(15),
    SET_CHARACTER_ID(16),
    MIGRATE_COMMAND(17),     // 189 ready
    ALIVE_REQ(18),     // 189 ready
    PING_CHECK_RESULT(19),
    AUTHEN_CODE_CHANGED(20),     // 189 ready
    AUTHEN_MESSAGE(21),
    SECURITY_PACKET(22),
    ...
    SET_MAP_OBJECT_VISIBLE(51),     // 189 ready
    ...
    INVENTORY_OPERATION(64),     // 189 ready
    INVENTORY_GROW(65),     // 189 ready
    STAT_CHANGED(66),     // 189 ready
    TEMPORARY_STAT_SET(67),     // 189 ready
    TEMPORARY_STAT_RESET(68),     // 189 ready
    FORCED_STAT_SET(69),     // 189 ready
    FORCED_STAT_RESET(70),     // 189 ready
    CHANGE_SKILL_RECORD_RESULT(71),     // 189 ready
    CHANGE_STEAL_MEMORY_RESULT(72),     // 189 ready
    USER_DAMAGE_ON_FALLING_CHECK(73),     // 189 ready
    PERSONAL_SHOP_BUY_CHECK(81),
    MOB_DROP_MESO_PICKUP(75),     // 189 ready
    BREAK_TIME_FIELD_ENTER(83),
    RUNE_ACT_SUCCESS(84),
    RESULT_STEAL_SKILL_LIST(78),     // 189 ready
    SKILL_USE_RESULT(86),
    EXCL_REQUEST(80),     // 189 ready
    GIVE_POPULARITY_RESULT(81),     // 189 ready
    MESSAGE(82),     // 189 ready
    MEMO_RESULT(83),     // 189 ready
    MAP_TRANSFER_RESULT(84),     // 189 ready
    ANTI_MACRO_RESULT(85),     // 189 ready
    ANTI_MACRO_BOMB_RESULT(86),     // 189 ready
    CLAIM_RESULT(88),     // 189 ready
    SET_CLAIM_SVR_AVAILABLE_TIME(89),     // 189 ready
    CLAIM_SVR_STATUS_CHANGED(90),     // 189 ready
    STAR_PLANET_USER_COUNT(98),
    SET_TAMING_MOB_INFO(92),     // 189 ready
    QUEST_CLEAR(93),     // 189 ready
    ENTRUSTED_SHOP_CHECK_RESULT(94),     // 189 ready
    SKILL_LEARN_ITEM_RESULT(95),     // 189 ready
    SKILL_RESET_ITEM_RESULT(96),     // 189 ready
    ABILITY_RESET_ITEM_RESULT(97),     // 189 ready
    EXP_CONSUME_ITEM_RESULT(105),
    EXP_ITEM_GET_RESULT(99),     // 189 ready
    CHAR_SLOT_INC_RESULT(107),
    CHAR_RENAME_RESULT(108),
    GATHER_ITEM_RESULT(102),     // 189 ready
    SORT_ITEM_RESULT(103),     // 189 ready
    CHARACTER_INFO(106),     // 189 ready
    PARTY_RESULT(107),     // 189 ready
    PARTY_MEMBER_CANDIDATE_RESULT(108),     // 189 ready
    URUS_PARTY_MEMBER_CANDIDATE_RESULT(109),     // 189 ready
    PARTY_CANDIDATE_RESULT(110),     // 189 ready
    URUS_PARTY_RESULT(111),     // 189 ready
    INTRUSION_FRIEND_CANDIDATE_RESULT(119),
    INTRUSION_LOBBY_CANDIDATE_RESULT(120),
    EXPEDITION_RESULT(122),
    FRIEND_RESULT(116),     // 189 ready
    STAR_FRIEND_RESULT(124),
    LOAD_ACCOUNT_ID_OF_CHARACTER_FRIEND_RESULT(125),
    GUILD_REQUEST(119),     // 189 ready
    GUILD_RESULT(120),     // 189 ready
    ALLIANCE_RESULT(121),     // 189 ready
    TOWN_PORTAL(122),     // 189 ready
    BROADCAST_MSG(123),     // 189 ready
    INCUBATOR_RESULT(125),     // 189 ready
    INCUBATOR_HOT_ITEM_RESULT(126),     // 189 ready
    SHOP_SCANNER_RESULT(127),     // 189 ready
    SHOP_LINK_RESULT(128),     // 189 ready
    AUCTION_RESULT(136),
    AUCTION_MESSAGE(137),
    MARRIAGE_REQUEST(131),     // 189 ready
    MARRIAGE_RESULT(132),     // 189 ready
    WEDDING_GIFT_RESULT(133),     // 189 ready
    NOTIFY_MARRIED_PARTNER_MAP_TRANSFER(141),
    CASHPET_FOOD_RESULT(135),     // 189 ready
    CASHPET_PICK_UP_ON_OFF_RESULT(143),
    CASHPET_SKILL_SETTING_RESULT(137),     // 189 ready
    CASH_LOOK_CHANGE_RESULT(138),     // 189 ready
    CASHPET_DYEING_RESULT(146),
    SET_WEEK_EVENT_MESSAGE(140),     // 189 ready
    SET_POTION_DISCOUNT_RATE(141),     // 189 ready
    BRIDLE_MOB_CATCH_FAIL(142),     // 189 ready
    IMITATED_NPC_RESULT(143),     // 189 ready
    IMITATED_NPC_DATA(144),     // 189 ready
    LIMITED_NPC_DISABLE_INFO(146),     // 189 ready
    MONSTER_BOOK_SET_CARD(147),     // 189 ready
    MONSTER_BOOK_SET_COVER(148),     // 189 ready
    HOUR_CHANGE(156),
    MINIMAP_ON_OFF(150),     // 189 ready
    CONSULT_AUTH_KEY_UPDATE(151),     // 189 ready
    CLASS_COMPETITION_AUTH_KEY_UPDATE(152),     // 189 ready
    WEB_BOARD_AUTH_KEY_UPDATE(153),     // 189 ready
    SESSION_VALUE(154),     // 189 ready
    PARTY_VALUE(155),     // 189 ready
    FIELD_SET_VARIABLE(163),
    FIELD_VALUE(157),     // 189 ready
    BONUS_EXP_RATE_CHANGED(158),     // 189 ready
    FAMILY_CHART_RESULT(159),     // 189 ready
    FAMILY_INFO_RESULT(160),     // 189 ready
    FAMILY_RESULT(161),     // 189 ready
    FAMILY_JOIN_REQUEST(162),     // 189 ready
    FAMILY_JOIN_REQUEST_RESULT(163),     // 189 ready
    FAMILY_JOIN_ACCEPTED(164),     // 189 ready
    FAMILY_PRIVILEGE_LIST(165),     // 189 ready
    FAMILY_FAMOUS_POINT_INC_RESULT(166),     // 189 ready
    FAMILY_NOTIFY_LOGIN_OR_LOGOUT(167),     // 189 ready
    FAMILY_SET_PRIVILEGE(168),     // 189 ready
    FAMILY_SUMMON_REQUEST(169),     // 189 ready
    NOTIFY_LEVEL_UP(170),     // 189 ready
    NOTIFY_WEDDING(171),     // 189 ready
    NOTIFY_JOB_CHANGE(172),     // 189 ready
    SET_BUY_EQUIP_EXT(173),     // 189 ready
    SET_PASSENSER_REQUEST(174),     // 189 ready
    SCRIPT_PROGRESS_MESSAGE_BY_SOUL(175),     // 189 ready
    SCRIPT_PROGRESS_MESSAGE(176),     // 189 ready
    SCRUOT_PROGRESS_ITEM_MESSAGE(184),
    STATIC_SCREEN_MESSAGE(185),
    OFF_STATIC_SCREEN_MESSAGE(179),     // 189 ready
    WEATHER_EFFECT_NOTICE(180),     // 189 ready
    WEATHER_EFFECT_NOTICE_Y(181),     // 189 ready
    PROGRESS_MESSAGE_FONT(182),     // 189 ready
    DATA_CRC_CHECK_FAILED(183),     // 189 ready
    SHOW_SLOT_MESSAGE(184),     // 189 ready
    WILD_HUNTER_INFO(185),     // 189 ready
    ZERO_INFO(186),     // 189 ready
    ZERO_WP(187),     // 189 ready
    ZERO_INFO_SUB_HP(195),
    UI_OPEN(196),
    CLEAR_ANNOUNCED_QUEST(197),
    RESULT_INSTANCE_TABLE(191),     // 189 ready
    COOL_TIME_SET(199),
    ITEM_POT_CHANGE(193),     // 189 ready
    SET_ITEM_COOL_TIME(201),
    SET_AD_DISPLAY_INFO(195),     // 189 ready
    SET_AD_DISPLAY_STATUS(203),
    SET_SON_OF_LINKED_SKILL_RESULT(197),     // 189 ready
    ...
    RESULT_SET_STEAL_SKILL(206),     // 189 ready
    SLASH_COMMAND(214),
    START_NAVIGATION(215),
    FUNCKEY_SET_BY_SCRIPT(209),     // 189 ready
    CHARACTER_POTENTIAL_SET(210),     // 189 ready
    CHARACTER_POTENTIAL_RESET(211),     // 189 ready
    CHARACTER_HONOR_EXP(212),     // 189 ready
    ASWAN_RESULT(214),     // 189 ready
    READY_FOR_RESPAWN(215),     // 189 ready
    READY_FOR_RESPAWN_BY_POINT(223),
    OPEN_READY_FOR_RESPAWN_UI(224),
    CHARACTER_HONOR_GIFT(218),     // 189 ready
    CROSS_HUNTER_COMPLETE_RESULT(219),     // 189 ready
    CROSS_HUNTER_SHOP_RESULT(220),     // 189 ready
    ...
    DRESS_UP_INFO_MODIFIED(247),     // 189 ready
    RESET_STATE_FOR_OFF_SKILL(255),
    SET_OFF_STATE_FOR_OFF_SKILL(256),
    ISSUE_RELOGIN_COOKIE(250),     // 189 ready
    AVATAR_PACK_TEST(258),
    EVOLVING_RESULT(252),     // 189 ready
    ACTION_BAR_RESULT(253),     // 189 ready
    GUILD_SEARCH_RESULT(255),     // 189 ready
    ...
    AVATAR_MEGAPHONE_RES(266),     // 189 ready
    SET_AVATAR_MEGAPHONE(274),
    CLEAR_AVATAR_MEGAPHONE(275),
    REQUEST_EVENT_LIST(269),     // 189 ready
    LIKE_POINT(270),     // 189 ready
    SIGN_ERROR_ACK(278),
    ASK_AFTER_ERROR_ACK(279),
    EVENT_NAME_TAG(280),
    ACQUIRE_EVENT_NAME_TAG(281),
    JOB_FREE_CHANGE_RESULT(275),     // 189 ready
    ...
    CASH_SHOP_PREVIEW_INFO(292),     // 189 ready
    CHANGE_SOUL_COLLECTION_RESULT(300),
    SELECT_SOUL_COLLECTION_RESULT(301),
    MASTER_PIECE_REWARD(302),
    PENDANT_SLOT_INC_RESULT(296),     // 189 ready
    BOSS_ARENA_MATCH_SUCCESS(304),
    BOSS_ARENA_MATCH_FAIL(298),     // 189 ready
    BOSS_ARENA_MATCH_REQUEST_DONE(299),     // 189 ready
    ...
    TOP_TOWER_RANK_RESULT(311),     // 189 ready
    FRIEND_TOWER_RANK_RESULT(312),     // 189 ready
    TOWER_RESULT_UI_OPEN(313),     // 189 ready
    ...
    RETURN_TO_TITLE(326),
    RETURN_TO_CHARACTER_SELECT(320),     // 189 ready
    FLAME_WIZARD_FLAME_WALK_EFFECT(321),     // 189 ready
    FLAME_WIZARD_FLARE_BLINK(322),     // 189 ready
    ...
    MACRO_SYS_DATA_INIT(413),     // 189 ready

    // CStage::OnPacket : v176 -> 00E75B70
    SET_FIELD(414),     // 189 ready
    SET_FARM_FIELD(415),     // 189 ready
    // sub_E759A0(430),
    SET_CASH_SHOP(417),     // 189 ready

    // CField::OnPacket (general) : v176 -> 00844E10
    TRANSFER_FIELD_REQ_IGNORED(419),     // 189 ready
    TRANSFER_CHANNEL_REQ_IGNORED(420),     // 189 ready
    TRANSFER_PVP_REQ_IGNORED(421),     // 189 ready
    FIELD_SPECIFIC_DATA(422),     // 189 ready
    GROUP_MESSAGE(423),     // 189 ready
    FIELD_UNIVERSE_MESSAGE(424),     // 189 ready
    WHISPER(425),     // 189 ready
    SUMMITEM_INAVAILABLE(439),
    FIELD_EFFECT(427),     // 189 ready
    BLOW_WEATHER(428),     // 189 ready
    PLAY_JUKE_BOX(429),     // 189 ready
    ADMIN_RESULT(430),     // 189 ready
    QUIZ(432),     // 189 ready
    FIELD_SET_DESC(452),
    CLOCK(434),     // 189 ready
    SET_QUEST_CLEAR(456),
    ...
    DESTROY(459),
    STALK_RESULT(442),     // 189 ready
    // CField_Massacre::OnPacket
    MASSACRE_INC_GAUGE(443),     // 189 ready
    MASSACRE_RESULT(444),     // 189 ready
    // CField::OnPacket
    INIT(464),
    FOOT_HOLD_MOVE(446),     // 189 ready
    ...
    SET_ACHIEVE_RATE(459),     // 189 ready
    SET_QUICK_MOVE_INFO(460),     // 189 ready
    ...
    // CUserPool::OnPacket?
    USER_ENTER_FIELD(495),     // 189 ready
    USER_LEAVE_FIELD(496),     // 189 ready
    ...
    GATHER_RESULT(545),
    USER_EXPLODE(546),
    USER_HIT_BY_COUNTER(530),     // 189 ready
    PYRAMID_LETHAL_ATTACK(531),     // 189 ready
    MIXER_RESULT(549),
    ...
    // CUser::OnPetPacket
    PET_ACTIVATED(568),     // 189 ready
    PET_MOVE(569),     // 189 ready
    PET_ACTION(581),
    PET_ACTION_SPEAK(570),     // 189 ready
    PET_NAME_CHANGED(571),     // 189 ready
    PET_LOAD_EXCEPTION_LIST(573),     // 189 ready
    PET_HUE_CHANGED(574),     // 189 ready
    PET_MODIFIED(577),     // 189 ready
    PET_ACTION_COMMAND(578),     // 189 ready

    // CUser::OnDragonPacket
    DRAGON_CREATED(590),
    DRAGON_MOVE(580),     // 189 ready
    DRAGON_REMOVE(592),
    DRAGON_REMOVE_RP_CHAR(593),

    // CUser::OnAndroidPacket
    ANDROID_CREATED(594),
    ANDROID_MOVE(583),     // 189 ready
    ANDROID_ACTION_SET(584),     // 189 ready
    ANDROID_MODIFIED(585),     // 189 ready
    ANDROID_REMOVED(598),

    // CUser::OnFoxManPacket
    FOX_MAN_ENTER_FIELD(587),     // 189 ready
    FOX_MAN_MOVE(600),
    FOX_MAN_EXCL_RESULT(589),     // 189 ready
    FOX_MAN_SHOW_CHANGE_EFFECT(590),     // 189 ready
    FOX_MAN_MODIFIED(603),
    FOX_MAN_LEAVE_FIELD(592),     // 189 ready

    // CUser::OnSkillPetPacket
    SKILL_PET_MOVE(594),     // 189 ready
    SKILL_PET_ACTION(595),     // 189 ready
    SKILL_PET_STATE(596),     // 189 ready
    ...
    // CUserLocal::OnPacket
    EMOTION(685),
    ANDROID_EMOTION(612),     // 189 ready
    EFFECT(687),
    TELEPORT(688),
    MESO_GIVE_SUCCEEDED(690),
    MESO_GIVE_FAILED(691),
    QUEST_RESULT(692),
    NOTIFY_HP_DEC_BY_FIELD(659),     // 189 ready
    USER_PET_SKILL_CHANGED(660),     // 189 ready
    BALLOON_MSG(695),
    PLAY_EVENT_SOUND(662),     // 189 ready
    PLAY_MINIGAME_SOUND(663),     // 189 ready
    MAKER_RESULT(698),
    ...
    OPEN_WEB_UI(704),
    SET_DIRECTION_MODE(671),     // 189 ready
    SET_IN_GAME_DIRECTION_MODE(672),     // 189 ready
    SET_STAND_ALONE_MODE(673),     // 189 ready
    HIRE_TUTOR(708),
    TUTOR_MSG(709),
    ...
    RESULT(728),
    GATHER_REQUEST_RESULT(693),     // 189 ready
    RUNE_STONE_USE_ACK(694),     // 189 ready
    BAG_ITEM_USE_RESULT(731),
    RANDOM_TELEPORT_KEY(696),     // 189 ready
    SET_GAGE_POINT(697),     // 189 ready
    IN_GAME_DIRECTION_EVENT(734),
    MEDAL_REISSUE_RESULT(699),     // 189 ready
    DODGE_SKILL_READY(736),
    REMOVE_MICRO_BUFF_SKILL(737),
    VIDEO_BY_SCRIPT(738),
    REWARD_MOB_LIST_RESULT(739),
    INC_JUDGEMENT_STACK_RESPONSE(740),
    INC_CHARM_BY_CASHP_R_MSG(705),     // 189 ready
    SET_BUFF_PROTECTOR(706),     // 189 ready
    INC_LARKNESS_RESPONSE(743),
    DETONATE_BOMB(708),     // 189 ready
    ...
    OPEN_URL(777),
    ZERO_COMBAT_RECOVERY(742),     // 189 ready
    ...
    SKILL_COOLTIME_SET(853),     // 189 ready

    // CSummonedPool::OnPacket
    SUMMONED_CREATED(892),
    SUMMONED_REMOVED(893),
    SUMMONED_MOVE(857),     // 189 ready
    SUMMONED_ATTACK(858),     // 189 ready
    SUMMONED_ATTACK_PVP(859),     // 189 ready
    SUMMONED_SET_REFERENCE(860),     // 189 ready
    SUMMONED_SKILL(861),     // 189 ready
    SUMMONED_SKILL_PVP(862),     // 189 ready
    SUMMONED_UPDATE_HP_TAG(900),
    SUMMONED_ATTACK_DONE(901),
    SUMMONED_SET_RESIST(902),
    SUMMONED_ACTION_CHANGE(903),
    SUMMONED_ASSIST_ATTACK_REQUEST(867),     // 189 ready
    SUMMONED_SUMMON_ATTACK_ACTIVE(905),
    SUMMONED_BEHOLDER_REVENGE_ATTACK(906),
    SUMMONED_HIT(907),

    // CMobPool::OnPacket
    MOB_ENTER_FIELD(870),     // 189 ready
    MOB_LEAVE_FIELD(871),     // 189 ready
    MOB_CHANGE_CONTROLLER(872),     // 189 ready
    MOB_SET_AFTER_ATTACK(911),
    MOB_BLOCK_ATTACK(912),
    MOB_CRC_KEY_CHANGED(886),     // 189 ready

    // CMobPool::OnMobPacket
    MOB_MOVE(876),     // 189 ready
    MOB_CONTROL_ACK(915),
    MOB_STAT_SET(879),     // 189 ready
    MOB_STAT_RESET(880),     // 189 ready
    MOB_SUSPEND_RESET(881),     // 189 ready
    MOB_AFFECTED(882),     // 189 ready
    MOB_DAMAGED(883),     // 189 ready
    MOB_SPECIAL_EFFECT_BY_SKILL(884),     // 189 ready
    MOB_CRC_DATA_REQUEST(925),
    MOB_HP_INDICATOR(887),     // 189 ready
    MOB_CATCH_EFFECT(888),     // 189 ready
    MOB_STEAL_EFFECT(928),
    MOB_EFFECT_BY_ITEM(890),     // 189 ready
    MOB_SPEAKING(891),     // 189 ready
    MOB_MESSAGING(892),     // 189 ready
    MOB_SKILL_DELAY(893),     // 189 ready
    ESCORT_FULL_PATH(933),
    ESCORT_STOP_END_PERMISSION(934),
    ESCORT_STOP_BY_SCRIPT(935),
    ESCORT_STOP_SAY(936),
    ESCORT_RETURN_BEFORE(937),
    MOB_NEXT_ATTACK(899),     // 189 ready
    ...
    MOB_ATTACKED_BY_MOB(933),     // 189 ready

    // CMinionPool::OnPacket
    MINION_ENTER_FIELD(935),     // 189 ready
    MINION_LEAVE_FIELD(936),     // 189 ready
    MINION_CHANGE_CONTROLLER(937),     // 189 ready
    MINION_GEN_BEYOND_SPLIT(938),     // 189 ready

    // CNpcPool::OnPacket : v176 -> 00CB5250
    NPC_ENTER_FIELD(939),     // 189 ready
    NPC_LEAVE_FIELD(940),     // 189 ready
    NPC_ENTER_FIELD_FOR_QUICK_MOVE(986),
    NPC_CHANGE_CONTROLLER(942),     // 189 ready
    NPC_IMITATE_DATA(151),
    NPC_UPDATE_LIMITED_DISABLE_INFO(153),
    SET_NPC_SCRIPT(1004),

    // CNpcPool::OnNpcPacket : v176 -> 00CB4BF0
    NPC_MOVE(943),     // 189 ready
    NPC_UPDATE_LIMITED_INFO(947),     // 189 ready
    ...
    EMPLOYEE_ENTER_FIELD(963),     // 189 ready
    EMPLOYEE_LEAVE_FIELD(964),     // 189 ready
    EMPLOYEE_MINI_ROOM_BALLOON(1008),

    // CDropPool::OnPacket
    DROP_ENTER_FIELD(967),     // 189 ready
    DROP_LEAVE_FIELD(969),     // 189 ready

    // CMessageBoxPool::OnPacket
    CREATE_MESSAGE_BOX_FAILED(1012),
    MESSAGE_BOX_ENTER_FIELD(971),     // 189 ready
    MESSAGE_BOX_LEAVE_FIELD(972),     // 189 ready

    // CAffectedAreaPool::OnPacket
    AFFECTED_AREA_CREATED(973),     // 189 ready
    INSTALLED_AREA_FIRE(1016),
    AFFECTED_AREA_REMOVED(975),     // 189 ready

    // CTownPortalPool::OnPacket
    TOWN_PORTAL_CREATED(976),     // 189 ready
    TOWN_PORTAL_REMOVED(977),     // 189 ready
    ...
    OPEN_GATE_CREATED(981),     // 189 ready
    OPEN_GATE_CLOSE(982),     // 189 ready
    OPEN_GATE_REMOVED(983),     // 189 ready


    // CReactorPool::OnPacket
    REACTOR_CHANGE_STATE(984),     // 189 ready
    REACTOR_IDK(1027),
    REACTOR_ENTER_FIELD(986),     // 189 ready
    REACTOR_RESET_STATE(1029),
    REACTOR_OWNER_INFO(988),     // 189 ready
    REACTOR_REMOVE(989),     // 189 ready
    REACTOR_LEAVE_FIELD(990),     // 189 ready
    ...
    DECOMPOSER_ENTER_FIELD(991),     // 189 ready
    DECOMPOSER_LEAVE_FIELD(992),     // 189 ready
    ...
    // CScriptMan::OnPacket
    SCRIPT_MESSAGE(1257),     // 189 ready

    // CShopDlg::OnPacket
    SHOP_OPEN(1282),
    SHOP_RESULT(1259),     // 189 ready
    ...
    STORE_BANK_GET_ALL_RESULT(1283),     // 189 ready
    STORE_BANK_RESULT(1284),     // 189 ready

    // CAdminShopDlg::OnPacket
    ADMIN_SHOP_RESULT(1260),     // 189 ready
    ADMIN_SHOP_COMMODITY(1261),     // 189 ready
...
// CCashShop::OnPacket
    CASH_SHOP(1340),
    CASH_SHOP_QUERY_CASH_RESULT(1320),     // 189 ready
    CASH_SHOP_CASH_ITEM_RESULT(1321),     // 189 ready
    CASH_SHOP_PURCHASE_EXP_CHANGED(1322),     // 189 ready
    ...
    PET_CONSUME_ITEM_INIT(1392),     // 189 ready
