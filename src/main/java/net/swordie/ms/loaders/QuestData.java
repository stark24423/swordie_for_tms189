    ...
    public static void loadQuestsFromWZ() {
        ...
        for (Node questIDNode : XMLApi.getAllChildren(mainNode)) {
            ...
            for (Node statusNode : XMLApi.getAllChildren(questIDNode)) {
                if (XMLApi.getNamedAttribute(statusNode, "name").matches("-?\\d+")) {//判斷是否為整數
        ...
        for (Node questIDNode : XMLApi.getAllChildren(mainNode)) {
            ...
            for (Node statusNode : XMLApi.getAllChildren(questIDNode)) {
                //log.error(XMLApi.getNamedAttribute(statusNode, "name").matches("-?\\d+"));
                if (XMLApi.getNamedAttribute(statusNode, "name").matches("-?\\d+")) {
